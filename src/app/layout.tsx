...
export const metadata = {
  title: 'ProtectedPay | Secure Crypto Transfers on KAIA',
  description: 'Secure crypto transfers, group payments, and smart savings on the KAIA blockchain',
  keywords: 'crypto, payments, blockchain, KAIA, DeFi, secure transfers, group payments',
